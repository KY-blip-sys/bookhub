// BookHub: BookHubのプランキー（plus/pro/premium）と、StripeのPrice ID（環境変数）の対応表。
//
// Price ID自体はVercelの環境変数（STRIPE_PLUS_PRICE_ID / STRIPE_PRO_PRICE_ID / STRIPE_PREMIUM_PRICE_ID）に置き、
...
// プランキー（'plus' | 'pro' | 'premium'）からStripeのPrice IDを返す。未設定・未知のプランならnull
